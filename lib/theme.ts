...
const Tumbly = localFont({ src: '../public/Tumbly.otf', variable: '--font-tumbly' });
...
const fonts = `'Tumbly', system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', 'Roboto', 'Helvetica Neue', Helvetica, sans-serif`
